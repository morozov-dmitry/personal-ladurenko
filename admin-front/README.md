...
- `VITE_APP_ENV` - Application environment (automatically set by Vite based on mode)
...
For production, update the `VITE_API_BASE_URL` to point to your production API endpoint.
